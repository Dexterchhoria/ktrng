    ...
    <>
      ...
      >
        ...
        <div className="relative inline-block text-center">
          <span className="absolute -top-6 text left-8 text-2xl font-semibold">
            10th Edition
          </span>

          <h1 className="text-5xl text md:text-8xl font-bold px-4 relative z-10">
            KALTARANG'25
          </h1>

          <span className="absolute text -bottom-10 text-osake  right-6 text-3xl font-semibold">
            A Voxel Verse
          </span>
        </div>
      ...
      <section className="bg-black text-white py-16 px-6 lg:px-16 flex flex-col lg:flex-row items-center relative">
        ...
        <div className="lg:w-1/2 mt-8 lg:mt-0 lg:pl-12 text-center lg:text-left">
          <h2 className="text-4xl font-bold text text-center mb-4">
            About KALTARANG'25
          </h2>
      ...
      <section className="bg-black text-white py-16 px-6 md:px-16">
        <h2 className="text-4xl text font-bold text-center mb-8">
          DISCOVER MORE
        </h2>
        <p className="text-center text-xl text italic text-gray-300 mb-6">
          Past Events
        </p>
        <Carousel />
        <div className="absolute bottom-0 left-0 w-full h-32 bg-gradient-to-b from-transparent to-black"></div>
